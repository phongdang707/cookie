...
export default function SettingStylePage() {
  return (
    <div className="top__banner setting__style">
      <div className="top__banner icon-cookie">
        <svg
      ...
      <p className="top__banner setting__style__param">
        We use cookie to improve your experience on our site. By using our site
        you consent cookies. Learn more
      </p>

      <div className="top__banner setting__style__ok">Oke</div>
    </div>
  );
}
